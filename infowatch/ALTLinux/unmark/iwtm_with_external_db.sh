...
|                        ВНИМАНИЕ                          |
+----------------------------------------------------------+
| Этот скрипт предназначен для установки TM с удаленной БД.|
| 							   |
| Для коробочной установки СУБД не требуется выполнение    |
| скрипта. СУБД установится авторматически.		   |
|                                                          |
| Продолжить? (y/N)                                        |
+----------------------------------------------------------+
EOF

read -rp "Введите y или n: " answer
